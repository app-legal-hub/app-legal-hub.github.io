...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const app = await loadDocument(appSlug, 'marketing');
    ...
    return {
        title: `${app.name}`,
        description: `Discover ${app.name} — learn about features, benefits, and how to get started.`,
        openGraph: {
            title: `${app.name}`,
            description: `Discover ${app.name}`,
            type: 'website',
        },
    };
}
        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <div className="border-b border-slate-200 bg-white">
                <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8">
                    ...
                    <p className="mt-1 text-sm text-slate-600">About the App</p>
                </div>
            </div>
